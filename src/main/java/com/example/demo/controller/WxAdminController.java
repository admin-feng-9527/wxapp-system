...
public class WxAdminController {
    ...
    public Map<String,String> wxaddcourse(CourseCustom courseCustom)throws Exception{
        Map<String,String> map = new HashMap<String, String>();
        System.out.println(courseCustom.getCoursename());
        System.out.println(courseCustom.getCollegeid());
    ...
    public Map<String,Object> wxaddteacher(TeacherCustom teacherCustom)throws Exception{
        Map<String,Object> map = new HashMap<String,Object>();
        System.out.println(teacherCustom.getUsername());
    ...
    @RequestMapping(value = "/wxselectTeacher",method ={RequestMethod.POST,RequestMethod.GET})
    public Map<String,Object> wxselectteacher(String name,Model model)throws Exception{
        Map<String,Object> map = new HashMap<String, Object>();
        List<TeacherCustom> teacherlist = teacherService.findByName(name);
