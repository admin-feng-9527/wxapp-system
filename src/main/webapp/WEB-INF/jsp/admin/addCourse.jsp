			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" action="<%=request.getContextPath()%>/admin/addCourse" id="editfrom" method="post">
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-sm-2 control-label" name="coursetype">课程类型：</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label">周节数：</label>
							<div class="col-sm-10">
								<input type="number" class="form-control" name="score" placeholder="请输入节数">
							</div>
						</div>
